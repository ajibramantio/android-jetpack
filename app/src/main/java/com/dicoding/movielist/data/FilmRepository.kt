                    ...
                    if (response.title == filmTitle) {
                        ...
                        remoteDataSource.getMovie(filmTitle, object : RemoteDataSource.LoadMovieCallback {
                            override fun onMovieReceived(movieResponse: MovieResponse) {
                                movie.filmEntity = FilmEntity(movieResponse.id, movieResponse.title, movieResponse.genre, movieResponse.overview, movieResponse.imdbScore, movieResponse.releaseYear, movieResponse.duration, movieResponse.photo, movieResponse.favorited, movieResponse.type)
                    ...
                    if (response.title == filmTitle) {
                        ...
                        remoteDataSource.getTvShow(filmTitle, object : RemoteDataSource.LoadTvShowCallback {
                            override fun onTvShowReceived(tvShowResponse: TvShowResponse) {
                                tvShow.filmEntity = FilmEntity(tvShowResponse.id, tvShowResponse.title, tvShowResponse.genre, tvShowResponse.overview, tvShowResponse.imdbScore, tvShowResponse.releaseYear, tvShowResponse.duration, tvShowResponse.photo, tvShowResponse.favorited, tvShowResponse.type)
